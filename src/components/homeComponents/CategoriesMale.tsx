...
const Categories = () => {
  ...
  return (
    <div className='relative flex flex-col justify-between items-center w-full h-[100vh] snap-center bg-fixed bg-[url("/banner4.jpg")] bg-cover bg-no-repeat bg-center'>
          ...
          {categoriesMale.map((c, index) => (
            ...
            >
              <div className='w-full h-full'>
                    <Image alt='' src={c.image} height={200} width={200} className='group-hover:scale-110 custom-transition w-full h-full object-cover' />
                  </div>
